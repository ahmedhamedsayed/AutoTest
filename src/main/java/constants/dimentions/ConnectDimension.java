...
public class ConnectDimension {
	...
	private void setButtonDimension(int w, int h) {
		buttonDimension[0] = new Dimension(141 + w, 555 + h, 100, 30);
		buttonDimension[1] = new Dimension(-242 + w, 555 + h, 100, 30);
		buttonDimension[2] = new Dimension(141 + w, 555 + h, 100, 30);
		buttonDimension[3] = new Dimension(-242 + w, 555 + h, 100, 30);
	}
}
