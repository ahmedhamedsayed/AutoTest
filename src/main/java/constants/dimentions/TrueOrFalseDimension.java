...
public class TrueOrFalseDimension {
    ...
    private void setLabelDimension(int w, int h) {
        ...
        labelDimension[1] = new Dimension(189 + w, 230 + h, 55, 30);
        labelDimension[2] = new Dimension(-192 + w, 230 + h, 150, 30);
    }
    ...
    private void setButtonDimension(int w, int h) {
        buttonDimension[0] = new Dimension(141 + w, 270 + h, 100, 30);
        buttonDimension[1] = new Dimension(-242 + w, 270 + h, 100, 30);
        buttonDimension[2] = new Dimension(141 + w, 270 + h, 100, 30);
        buttonDimension[3] = new Dimension(-242 + w, 270 + h, 100, 30);
    }
}
